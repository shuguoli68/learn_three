...
//    selectNotificationSubject.close();
  ...
  Future<void> _showNotificationWithNoBody() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(
        2, 'plain title', null, platformChannelSpecifics,
        payload: 'item x');
  }
  ...
  Future<void> _showNotificationWithNoSound() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(3, '<b>silent</b> title',
...
//    return filePath;
  ...
  Future<void> _showBigPictureNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
        4, 'big text title', 'silent body', platformChannelSpecifics);
  }
  ...
  Future<void> _showBigPictureNotificationHideExpandedLargeIcon() async {
    ...
    NotificationDetails(androidPlatformChannelSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
        6, 'big text title', 'silent body', platformChannelSpecifics);
  }
  ...
  Future<void> _showNotificationMediaStyle() async {
    ...
    NotificationDetails(androidPlatformChannelSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
        7, 'notification title', 'notification body', platformChannelSpecifics);
  }
  ...
  Future<void> _showBigTextNotification() async {
    ...
    NotificationDetails(androidPlatformChannelSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
        8, 'big text title', 'silent body', platformChannelSpecifics);
  }
  ...
  Future<void> _showInboxNotification() async {
    ...
    NotificationDetails(androidPlatformChannelSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
        9, 'inbox title', 'inbox body', platformChannelSpecifics);
  }
